...
:   [Poster presented at yoyoyo](yoyoyyo)   
    [Poster poster](yoyoyo)
...
As part of my [NSF-NRT Graduate Training Program in Sensory Science](http://catss.umn.edu/opportunities.htm) Fellowship, I am currently participating in a rotation in the UMN Computational Visual Neuroscience Lab. In the lab, I am working on implementation and analysis of encoding models for a multi-session, multi-subject, high-resolution dataset currently being collected at the [Center for Magnetic Resonance Research](cmrr.umn.edu). 
